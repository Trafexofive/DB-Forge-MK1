...
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/admin/databases/spawn/$DB_NAME")
...
"$CLIENT_SCRIPT" "POST" "/admin/databases/spawn/$DB_NAME_2" > /dev/null
RESPONSE=$("$CLIENT_SCRIPT" "GET" "/admin/databases")
...
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/admin/databases/prune/$DB_NAME_2")
...
TABLE_NAME="users"
"$CLIENT_SCRIPT" "POST" "/admin/databases/spawn/$DB_NAME_DATA" > /dev/null
...
EOF
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/api/db/$DB_NAME_DATA/tables" "scripts/create_table_payload.json")
...
EOF
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/api/db/$DB_NAME_DATA/tables/$TABLE_NAME/rows" "scripts/insert_payload.json")
...
RESPONSE=$("$CLIENT_SCRIPT" "GET" "/api/db/$DB_NAME_DATA/tables/$TABLE_NAME/rows")
...
RESPONSE=$("$CLIENT_SCRIPT" "GET" "/api/db/$DB_NAME_DATA/tables/$TABLE_NAME/rows?age=24")
...
EOF
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/api/db/$DB_NAME_DATA/query" "scripts/query_payload.json")
...
EOF
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/api/db/$DB_NAME_DATA/query" "scripts/insert_raw_payload.json")
...
EOF
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/api/db/$DB_NAME_DATA/query" "scripts/update_raw_payload.json")
...
EOF
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/api/db/$DB_NAME_DATA/query" "scripts/delete_raw_payload.json")
...
EOF
RESPONSE=$("$CLIENT_SCRIPT" "POST" "/api/db/$DB_NAME_DATA/query" "scripts/error_query_payload.json")
...
RESPONSE=$("$CLIENT_SCRIPT" "GET" "/api/db/$NON_EXISTENT_DB/tables/some_table/rows")
...
"$CLIENT_SCRIPT" "POST" "/admin/databases/prune/$DB_NAME" > /dev/null
"$CLIENT_SCRIPT" "POST" "/admin/databases/prune/$DB_NAME_DATA" > /dev/null
"$CLIENT_SCRIPT" "POST" "/admin/databases/prune/test_db_spawn_01" > /dev/null
"$CLIENT_SCRIPT" "POST" "/admin/databases/prune/test_db_spawn_02" > /dev/null
"$CLIENT_SCRIPT" "POST" "/admin/databases/prune/test_db_data_01" > /dev/null
"$CLIENT_SCRIPT" "POST" "/admin/databases/prune/test_db_raw_sql" > /dev/null
